---
title: "Asas-Asas Hukum Jaminan"
date: 2025-11-27
permalink: /posts/2025/11/asas-hukum-jaminan/
tags:
  - Academic Law
  - Hukum Jaminan
  - Hukum Perdata
author: "Cika  Karin, d.B.A., d.M.C., B.A., B.A., S.H."
excerpt: "Artikel ini membahas tentang asas-asas mengenai Hukum Jaminan."
---
# Asas Tidak Dapat Dibagi-bagi (*Onsplitsbaarheid* / *Indivisibility*)
Asas ini mengandung makna bahwa hak jaminan membebani objek jaminan secara utuh dan total untuk menjamin pelunasan seluruh utang. Secara prinsip, satu kesatuan benda jaminan bertanggung jawab atas satu kesatuan utang. Konsekuensi yuridisnya adalah pelunasan sebagian utang (partial payment) oleh debitur tidak secara otomatis membebaskan sebagian benda jaminan dari beban sita. Hak jaminan baru akan hapus secara sempurna jika utang telah lunas 100% beserta bunga dan biaya lainnya (Satrio, 2002).<br>
Regulasi di Indonesia:<br>
- Pasal 1160 KUHPerdata (Gadai): Menyatakan bahwa gadai tidak dapat dibagi-bagi. Meskipun utang dibagi di antara para ahli waris, barang gadai tetap terikat untuk sisa utang yang belum lunas.
- Pasal 4 UU No. 4 Tahun 1996 (Hak Tanggungan): Menegaskan bahwa Hak Tanggungan membebani hak atas tanah secara utuh, kecuali jika diperjanjikan lain (misalnya dalam kasus Roya Parsial untuk proyek perumahan).
# Asas Spesialitas (*Specialiteit*)
Asas ini mensyaratkan bahwa hak jaminan kebendaan hanya dapat dibebankan atas benda-benda yang tertentu, terperinci, dan individual. Dalam akta pembebanan jaminan, objek yang dijadikan agunan tidak boleh disebut secara umum (misalnya: "seluruh aset saya"). Objek tersebut harus dideskripsikan secara spesifik (lokasi, ukuran, batasan, nomor sertifikat, nomor rangka/mesin) agar tidak tertukar dengan aset lain. Hal ini bertujuan untuk menentukan aset mana yang terkena hak preferen jika terjadi kepailitan (Sofwan, 2001).<br>
Regulasi di Indonesia:<br>
- Pasal 1174 KUHPerdata: Hipotek hanya dapat diletakkan atas benda yang ditunjuk secara khusus.
- Pasal 8 & 11 UU No. 4 Tahun 1996: Akta Pemberian Hak Tanggungan (APHT) wajib mencantumkan uraian yang jelas mengenai objek Hak Tanggungan. Ketidakjelasan objek dapat menyebabkan jaminan batal demi hukum (null and void).
- UU No. 42 Tahun 1999 (Fidusia): Mewajibkan adanya daftar benda yang menjadi objek jaminan fidusia.
# Asas Publisitas (*Publiciteit*)
Asas ini mewajibkan bahwa pembebanan hak jaminan atas benda tertentu (khususnya benda terdaftar) harus didaftarkan dalam register umum agar diketahui oleh pihak ketiga (masyarakat luas). Tujuan utama publisitas adalah perlindungan hukum bagi pihak ketiga yang beritikad baik. Dengan pendaftaran, pihak ketiga dapat mengetahui status benda tersebut apakah sedang dijaminkan atau bersih (clean and clear). Publisitas juga merupakan syarat mutlak lahirnya hak kebendaan tersebut (syarat konstitutif) (Bahsan, 2012).<br>
Regulasi di Indonesia:<br>
